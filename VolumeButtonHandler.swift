...
//  Forked by Warner Wilson on 01.04.2023.
...
/// This class converts the UIKit class to a SwiftUI class
struct VolumeButtonHandlerView: UIViewRepresentable {
    ...
    init(volumeButtonHandler: VolumeButtonHandler) {
        self.volumeButtonHandler = volumeButtonHandler
    }
    ...
    func updateUIView(_ uiView: UIView, context: Context) {
        if !volumeButtonHandler.isStarted {
            volumeButtonHandler.start()
        }
    }
    
    func makeCoordinator() -> Coordinator {
        Coordinator(volumeButtonHandler: volumeButtonHandler)
    }
...
//        }
        ...
        // Uncomment to reset volume to initial value
        //setSystemVolume(initialVolume)
    }
}
